...
public class _02_PasswordChecker implements KeyListener {
	 ...
	 */
	static final String regexCriteria1 = ".{8,20}";
	...
	/*
	 * 4. Check there is at least 1 special character, where special characters are
	 * one of the following, @#$%^&-+=()
	 */
	static final String regexCriteria4 = "[@#$%^&-+=()]";

	/*
	 * *BONUS* Add more password criteria. Some suggestions are: - check for no
	 * whitespace characters - check for lower case letters - check for maximum of
	 * 20 characters
	 */
	static final String regexCriteria5 = "[^\\s]{1,}";
	static final String regexCriteria6 = "[a-z]";
	/*
	 * Below is a more rigorous regex password checker. Can you figure out what it's
	 * checking? \A(?=\w{6,10}\z)(?=[^a-z]*[a-z])(?=(?:[^A-Z]*[A-Z]){3})\D*\d.*\z
	 * 
	 * 
	...
	static final String CRITERIA1 = "A minimum of 8 and a maximum of 20 characters";
	...
	static final String CRITERIA5 = "No whitespaces";
	static final String CRITERIA6 = "Must contain at least 1 lower case letter";
