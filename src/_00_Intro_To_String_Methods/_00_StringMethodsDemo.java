...
public class _00_StringMethodsDemo {
	/*
	 * In Java Strings are objects that are immutable, meaning you can't directly
	 * modify or change them. Java provides methods that indirectly modify a String
	 * by returning a new String object with the modifications.
	 * 
	...
	public static void main(String[] args) {
		...
		System.out.println("1. The substring '" + substring + "' appeared: " + numOccurances + " times in the string '"
				+ str + "'");
		...
		System.out.println("2. The substring '" + substring + "' appeared: " + numOccurances + " times in the string '"
				+ str + "'");
	}
}
