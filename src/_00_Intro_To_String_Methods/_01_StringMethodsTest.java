...
class _01_StringMethodsTest {
	...
	void testFormatSpaces() {
		...
		assertEquals("This_String_should_have_its_spaces_filled_with_underscores",
				_01_StringMethods.formatSpaces("This String should have its spaces filled with underscores"));
		assertEquals("x_x_x_x_x_x_x_underscores_x_x_x_x_x_x",
				_01_StringMethods.formatSpaces("x x x x x x x underscores x x x x x x"));
	}
	...
	void testEncrypt() {
		...
		assertEquals("FCglYAwlISc1JWAvJmABLSE6KS4nYBAyLycyIS0tJTIz",
				_01_StringMethods.encrypt("The League of Amazing Programmers", '@'));
		assertEquals("JBkdFVAEH1AVEQRQAx8dFVAAAhUEChUcAw==",
				_01_StringMethods.encrypt("Time to eat some pretzels", 'p'));
	}

	@Test
	void testDecrypt() {
		assertEquals("Hello", _01_StringMethods.decrypt("KwYPDww=", 'c'));
		assertEquals("The League of Amazing Programmers",
				_01_StringMethods.decrypt("FCglYAwlISc1JWAvJmABLSE6KS4nYBAyLycyIS0tJTIz", '@'));
		assertEquals("Time to eat some pretzels",
				_01_StringMethods.decrypt("JBkdFVAEH1AVEQRQAx8dFVAAAhUEChUcAw==", 'p'));
	}

	@Test
	void testWordsEndWithSubstring() {
		assertEquals(3, _01_StringMethods.wordsEndsWithSubstring(
				"He quietly and slowly backed away from the bear that was hungrily looking at him", "ly"));
		assertEquals(2,
				_01_StringMethods.wordsEndsWithSubstring("He was visiting The League of Amazing Programmers.", "ing"));
		assertEquals(7, _01_StringMethods
				.wordsEndsWithSubstring("Here are multiple words that have the same letter at the end.", "e"));
	...
	void testPalindrome() {
		...
		assertTrue(
				_01_StringMethods.palindrome("Doc, Note: I Dissent. A Fast Never Prevents A Fatness. I Diet On Cod."));
